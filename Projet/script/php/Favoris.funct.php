...
function RWFav($Favoris){
    if (dirname($_SERVER['PHP_SELF']) == '/ProjetCocktails/Projet/script/php' || dirname($_SERVER['PHP_SELF']) == '/Projet/script/php')
        $path = '../../donnees/';                                                                    // appel JQuery
    else $path  = '../donnees/';                                                                     // appel include
